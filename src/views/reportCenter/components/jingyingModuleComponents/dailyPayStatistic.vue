 ...
 * @Date: 2022-07-01 11:05:32
 * @LastEditors: unfetteredman weixw2014@qq.com
 * @LastEditTime: 2022-07-01 11:05:58
 * @FilePath: \may_meet_backstage\src\views\reportCenter\components\jingyingModuleComponents\dailyPayStatistic.vue
-->
<template>
...
import { dailyPayStatistic } from "@/api/reportApi.js";
import { getDate } from "@/utils/date";
import tableConfig from "../tableConfig/mrfftj_table_config.js"; // 公用头条 安卓新增付费用户table 配置
...
export default {
  ...
  data() {
    return {
      list: [],
      customProps: {
        tableName: "dailyPayStatisticTableConfig", // tableName： table标识，用来做table的key
  ...
  methods: {
    async getTableData(data) {
      try {
        ...
        const res = await dailyPayStatistic(data || params);
        console.log("dailyPayStatistic res", res);
