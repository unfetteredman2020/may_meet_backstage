...
import { guestRetention } from "@/api/reportApi.js";
...
export default {
  ...
  data() {
    return {
      list: [],
      customProps: {
        tableName: "guestRetentionTableConfig", // tableName： table标识，用来做table的key
  ...
  methods: {
    async getTableData(data) {
      try {
        ...
        const res = await guestRetention(data || params);
        console.log("guestRetention res", res);
