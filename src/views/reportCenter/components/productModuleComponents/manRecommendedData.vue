...
import { getManRecommendData } from "@/api/reportApi.js";
import { getDate } from "@/utils/date";
import tableConfig from "../tableConfig/cp_manRecommendData_table_config.js"; // 公用头条 安卓新增付费用户table 配置
  ...
  methods: {
    async getTableData(data) {
      try {
        ...
        const res = await getManRecommendData(data || params);
        console.log("getManRecommendData res", res);
